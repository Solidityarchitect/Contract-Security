...
contract PuppyRaffle is ERC721, Ownable {
    ...
    function enterRaffle(address[] memory newPlayers) public payable {
        // q were custom reverts a thing in 0.7.6 of soildity?
        // what if it's 0?
    ...
    function selectWinner() external {
        ...
        // @audit overflow
        // Fiexs: Never version of solidity, bigger uints
        ...
        // report-written the winner wouldn't get the money if thier fallback was messed up!
    ...
    function withdrawFees() external {
        // .....?
        // q ok so, if the protocol has play
