...
contract L1BossBridge is Ownable, Pausable, ReentrancyGuard {
    ...
    // @audit-info IMPACT: High, LIKELIHOOD: High

    // if the vault approved the bridge... can a user steal funds from the vault?
    function depositTokensToL2(
        ...
        // @audit-info IMPACT: High  LIKELIHOOD: High - This allows an attacker to trigger the `Deposit` event any number of times
    ...
    function sendToL1(
        ...
        // e slither said this is bad, is that ok?
        // @audit-info IMPACT: High  LIKELIHOOD: High - The signer did not verify the signed message content
